...
export function StartHero() {
  return (
    <PageHero
      ...
      title="Partner with MindRise Wellness Initiative."
      lead="MindRise works with schools, youth groups, institutions, media partners, and community leaders to strengthen mental health literacy in Rwanda."
    />
  );
}
